...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    //*/Modified by tyd Greg 2014-03-10,for user folder close quickly,the original value is 800
...
//        rightLine = (ImageView) findViewById(R.id.rightline);
        ...
        if (cell != null) {
            mContent.setCellDimensions(grid.isLandscape ? grid.folderCellWidthLandPx 
            		:grid.folderCellWidthPx, grid.folderCellHeightPx, 
                    cell.getWidthGap(), cell.getHeightGap());
    ...
    public boolean onLongClick(View v) {
        ...
        mContent.setBackgroundResource(R.drawable.folder_content_bg);//zhangwuba add 2014-5-16
        //*/added by xuchao for folder fullscreen 20140514
...
//        final int width = mFolderIcon.getMeasuredWidth();
//        final int height = mFolderIcon.getMeasuredHeight();
//        Bitmap mFolderIconBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
//        Canvas canvas = new Canvas(mFolderIconBitmap); 
//        Paint p = new Paint();
...
//        canvas.drawLine(0, 0, width, 0, p);
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            if(!mLauncher.mEditMode && !TydtechConfig.TYDTECH_UNINSTALL_MIUI_FLAG){
                mLauncher.enterShakeEditMode();
    ...
    private void positionAndSizeAsIcon() {
        ...
        /*/Remarked by tyd Greg 2013-08-28,for iphone style folder
        setScaleX(0.8f);
        setScaleY(0.8f);
        setAlpha(0f);
        //*/
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        ...
        //*/Added by tyd Greg 2014-03-07,for show unread num
    ...
    public void onDragExit(DragObject d) {
        ...
        mReorderAlarm.cancelAlarm();
        mDragMode = DRAG_MODE_NONE;
		//added by xuchao for folder fullscreen 20140515
...
//        rightLine.setVisibility(View.INVISIBLE);
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (TydtechConfig.TYDTECH_UNINSTALL_MIUI_FLAG) {
         successfulDrop =
                success && (!beingCalledAfterUninstall || mUninstallSuccessful) && (d.dragSource instanceof Folder) && (target instanceof Workspace) || ((d.dragSource instanceof Folder) && (target instanceof Folder));
      ...
      //  Log.i("successfulDrop", "((d.dragSource instanceof Folder) && (target instanceof Folder))=="+((d.dragSource instanceof Folder) && (target instanceof Folder)));
       //Log.i("successfulDrop", "success="+success+",(!beingCalledAfterUninstall || mUninstallSuccessful)=="+((!beingCalledAfterUninstall || mUninstallSuccessful))
    //		   +",(d.dragSource instanceof Folder)="+(d.dragSource instanceof Folder)+",(target instanceof Workspace)=="+(target instanceof Workspace));
        if (successfulDrop) {
        ...
        if (TydtechConfig.TYDTECH_UNINSTALL_MIUI_FLAG) {
        	if (!success) {
        		Toast.makeText(mLauncher, R.string.uninstall_system_app, Toast.LENGTH_LONG).show();
		}
		}
    ...
    private void centerAboutIcon() {
        ...
        int centeredLeft = (mLauncher.getWindowManager().getDefaultDisplay().getWidth() - width)/2;
        int centeredTop = (mLauncher.getWindowManager().getDefaultDisplay().getHeight() - height)/2;
        //*/
    ...
    private int getFolderHeight() {
        int height = getPaddingTop() + getPaddingBottom()
                + getContentAreaHeight() + mFolderNameHeight + 30;
        return height;
    }

    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {

        int width = getPaddingLeft() + getPaddingRight() + mContent.getDesiredWidth() + 30;
        int height = getFolderHeight();
        ...
        //*/added by xuchao for folder fullscreen 20140515
        topLine.measure(contentAreaWidthSpec, MeasureSpec.makeMeasureSpec(5, MeasureSpec.EXACTLY));
        bottomLine.measure(contentAreaWidthSpec, MeasureSpec.makeMeasureSpec(5, MeasureSpec.EXACTLY));
//        leftLine.measure(5, contentAreaHeightSpec);
//        rightLine.measure(5, contentAreaHeightSpec);
        //*/
...
//        rightLine.setVisibility(View.INVISIBLE);
    ...
    public void onAdd(ShortcutInfo item) {
        ...
        /*/Added by tyd Greg 2014-03-17,for apphub
        item.apphubtype = AppHubInfo.NO_ID;
        //*/
