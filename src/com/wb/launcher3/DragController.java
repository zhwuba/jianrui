...
public class DragController {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if(TydtechConfig.CAN_SNAP_PAGE_WHEN_DRAG){
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if(TydtechConfig.CAN_SNAP_PAGE_WHEN_DRAG){
                    mActivePointerId = INVALID_POINTER;
                    mDragScroller.handleMotionEvent(ev);
                }
                //*/
                break;
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            break;
        case MotionEvent.ACTION_MOVE:
            /*/Modified by tyd Greg 2014-03-20,for move shortcuts and appwidgets more quickly and convenient
            handleMoveEvent(dragLayerX, dragLayerY);
            /*/
            if (TydtechConfig.CAN_SNAP_PAGE_WHEN_DRAG) {

                    try {
                        int pointIndex = ev.findPointerIndex(this.mActivePointerId);
                        if (pointIndex >= ev.getPointerCount()) {
                            Log.e(TAG,
                                    "onTouchEvent -- pointerIndex = " + pointIndex + "/ ev.getPointerCount() = "
                                            + ev.getPointerCount());
                            return true;
                        }
                        int[] pos = getClampedDragLayerPos(ev.getX(pointIndex), ev.getY(pointIndex));
                        //xuchao modified for not able to move private widget to another page 20140519
                        handleMoveEvent(pos[0], pos[1]);
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (TydtechConfig.CAN_SNAP_PAGE_WHEN_DRAG) {
                    ...
                    int pos[] = getClampedDragLayerPos(ev.getX(pointerIndex), ev.getY(pointerIndex));
                    //xuchao modified for not able to move private widget to another page 20140519
                    handleMoveEvent(pos[0], pos[1]);
            ...
            //*/Added by tyd Greg 2014-03-20,for move shortcuts and appwidgets more quickly and convenient
            else if (TydtechConfig.CAN_SNAP_PAGE_WHEN_DRAG) {
                mActivePointerId = INVALID_POINTER;
            }
            //*/
            endDrag();
    ...
    protected void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if(pointerId == mActivePointerId) {
            ...
            int[] dragLayerPos = getClampedDragLayerPos(ev.getX(newPointerIndex), ev.getY(newPointerIndex));
