...
class DeviceProfile {
    ...
    int hotseat_magin_bottom;
    int hotseat_magin_bottom_inverse;
    int hotseat_magin_navgationbar;
    //*/
    ...
    DeviceProfile(Context context,
        ...
        //*/zhangwuba 2014-5-7
        hotseat_magin_bottom = resources.getDimensionPixelSize(R.dimen.hotseat_magin_bottom);
        hotseat_magin_bottom_inverse = resources.getDimensionPixelSize(R.dimen.hotseat_magin_bottom_inverse);
        hotseat_magin_navgationbar = resources.getDimensionPixelSize(R.dimen.hotseat_magin_navgationbar);
        //*/
        ...
        /*/Added by tyd Greg 2014-03-06,for show the text two line
        ...
        if (TydtechConfig.SHOW_APP_NAME_USE_TWO_LINE_FLAG) {
            cellHeightPx = iconSizePx + singleLineHeight*2;
        }else {
            cellHeightPx = iconSizePx + singleLineHeight;
        }
        //*/
        ...
        */
        ...
        if (TydtechConfig.SHOW_SHORTCUT_NAME_IN_HOTSEAT_FLAG) {
            hotseatCellHeightPx = iconSizePx + singleLineHeight;
            hotseatBarHeightPx = hotseatCellHeightPx + 4 * edgeMarginPx + hotseat_magin_bottom;
            hotseatCellWidthPx = iconSizePx;
        } else {
            hotseatBarHeightPx = iconSizePx + 1 * edgeMarginPx;
            hotseatCellWidthPx = iconSizePx;
            hotseatCellHeightPx = iconSizePx;
        }
        //*/
        ...
        //*/
        folderCellHeightPx = cellHeightPx + (int) ((3f/2f) * edgeMarginPx) + 60;
        folderCellWidthPx = context.getResources().getDimensionPixelSize(R.dimen.folder_cell_width_port);
        folderCellWidthLandPx = context.getResources().getDimensionPixelSize(R.dimen.folder_cell_width_land);
        //Log.i("kkkkk", "folderCellWidthPx=="+folderCellWidthPx);
        ...
        if (orientation == CellLayout.LANDSCAPE &&
            ...
            */
        	 if (TydtechConfig.HIDE_GOOGLE_SEARCHBAR_FLAG) {
        		  padding.set(0, LauncherAppState.getStatusBarHeight(),
        				  hotseatBarHeightPx, edgeMarginPx * 7 + pageIndicatorHeightPx);
        	 }else{
        		  padding.set(searchBarSpaceHeightPx, edgeMarginPx,
                          hotseatBarHeightPx, edgeMarginPx);
        	 }
            ...
            if (isTablet()) {
            	//*/zhangwuba modify like phone
            	if (TydtechConfig.HIDE_GOOGLE_SEARCHBAR_FLAG) {
                    padding.set(0, LauncherAppState.getStatusBarHeight(), 
                            0, hotseatBarHeightPx + pageIndicatorHeightPx);
            	}else{
                ...
                /*/Modified by tyd Greg 2014-03-06,for hide search bar
	...
	public void layout(Launcher launcher) {
        ...
        if (hasVerticalBarLayout && !TydtechConfig.TYDTECH_UNINSTALL_MIUI_FLAG) {
            // Vertical search bar
        ...
        if (hasVerticalBarLayout) {
            ...
            lp.width = hotseatBarHeightPx - hotseat_magin_bottom_inverse;
            lp.height = LayoutParams.MATCH_PARENT;
            //*/zhangwuba modify 2014-4-16
            //hotseat.setPadding(0, 2 * edgeMarginPx,
              //      2 * edgeMarginPx, 2 * edgeMarginPx);
            lp.setMargins(0, 20, 0, 0);
            hotseat.setPadding(2 * edgeMarginPx, padding.top + edgeMarginPx,
                  0, padding.bottom - 4);
            //*/
        } else if (isTablet()) {
            ...
            lp.height = hotseatBarHeightPx - hotseat_magin_bottom_inverse;
            //*/zhangwuba modify 2014-4-16
            lp.setMargins(0, 0, 0, hotseat_magin_navgationbar);
            hotseat.setPadding(edgeMarginPx + gridGap, 0,
                    edgeMarginPx + gridGap,
                    2 * edgeMarginPx);
            //*/
        } else {
...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
     ...
     // The tablet profile is odd in that the landscape orientation
		...
		//*/
        //modified by tyd zl for mainmenu layout 20140305
        deviceProfiles.add(new DeviceProfile("Nexus 7",
                600, 960,  5, 5,  68, 14.4f,  5, 68)); 
        ...
        //*/Added by tyd Greg 2014-03-06,for a77(960x540) & a575(1280x720)
        deviceProfiles.add(new DeviceProfile("koobee m1&h1",
                335, 615,  4, 4,  63, 14, (hasAA ? 5 : 4), 63));
        //*/
