...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void showSearchBar(boolean animated) {
        ...
        if (animated) {
            ...
            if (mEnableDropDownDropTargets) {
                ...
                mQSBSearchBar.setAlpha(0);//modify for gone mQSBSearchBar for uninstall app 
            }
        }
    ...
    //*/added for uninstall appp
	public void setDeleteDropTargetBG(){
		mDropTargetBar.setBackgroundResource(R.drawable.uninstall_shadow);
	}
	
	public void setBackDeleteDropTargetBG(){
		mDropTargetBar.setBackgroundResource(0);
	}
	//*/
