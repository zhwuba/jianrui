...
public class GLSmallRaindrop extends GLMesh {
    private GLRainDropAlgorithm mGLRainDropAlgorithm;

    public GLSmallRaindrop() {
        super();
    ...
    public void onDraw(GL10 gl, float alpha) {
        ...
        if (this.mGLRainDropAlgorithm != null) {
            this.mGLRainDropAlgorithm.updateSmallRainDropInfo(2f * System.nanoTime() / 1000000000);
        }
    }
    ...
    public void setRainDropAlgorithm(float width, float height) {
        this.mGLRainDropAlgorithm = GLRainDropAlgorithm.getInstance(width, height, true);
    }

    public void setSmallRainScreenOffsetX(float transition) {
        if (this.mGLRainDropAlgorithm != null) {
            this.mGLRainDropAlgorithm.setSmallRainScreenOffsetX(transition);
        }
    }
