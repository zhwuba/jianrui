...
public class PageIndicator extends LinearLayout {
    ...
    //*/zhangwuba modify add isWorkspace 2014-6-6
    void addMarker(int index, PageMarkerResources marker, boolean allowAnimations, boolean isWorkspace) {
        ...
        //*/zhangwuba hide when landscape
        //Log.i("myl","zhangwuba -------  isWorkspace = " + isWorkspace);
  ...
  //*/zhangwuba modify add isWorkspace 2014-6-6
    void addMarkers(ArrayList<PageMarkerResources> markers, boolean allowAnimations, boolean isWorkspace) {
        for (int i = 0; i < markers.size(); ++i) {
            addMarker(Integer.MAX_VALUE, markers.get(i), allowAnimations,isWorkspace);
        }
    }
