...
import com.wb.launcher3.config.ProviderConfig;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE favorites (" +
                    ...
                    "newinstallflag INTEGER NOT NULL DEFAULT 0," + //Added by tyd Greg 2014-03-12,for new install 
            ...
            /*/Modified by tyd Greg 2014-03-11,for load default workspace
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        while ((type = parser.next()) != XmlPullParser.END_TAG ||
                            ...
                            //*/Added by tyd Greg 2013-09-27,read the cellx and celly
                            x = ar.getString(R.styleable.Favorite_x);
                            y = ar.getString(R.styleable.Favorite_y);
                            values.put(LauncherSettings.Favorites.CELLX, x);
                            values.put(LauncherSettings.Favorites.CELLY, y);
                            //*/
